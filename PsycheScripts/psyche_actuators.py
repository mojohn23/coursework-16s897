...
# Calculate torque
# r_sun = adcs.unit_vec(np.array([-psyche.bus_depth/2, -psyche.bus_width/2, psyche.bus_height/2])) # vary +/- to see direction change
r_sun = np.array([0, 0, 1]) # nominally, in +Z direction
